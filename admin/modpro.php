...
$id = $_GET['id'];
$selection_pre = $bdd->query("SELECT * FROM depute_provincial WHERE id='$id'");
...
<div class="container">
         ...
         <marquee behavior="" direction="left"><center><h3>MODIFIER LE CANDIDAT PRESIDENTIEL</h3></center></marquee>
                <div class="row">
                  <?php if (isset($error)) { ?>
